...
export function DataTablePagination<TData>({
  ...
  return (
    <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 px-2">
      ...
      Отображается {(pageNumber - 1) * pageSize + 1}-
        {Math.min(pageNumber * pageSize, totalCount)} из {totalCount}
      </div>
      <div className="flex flex-col lg:flex-row lg:items-center space-y-2 lg:space-x-8 lg:space-y-0">
        {/* Rows Per Page Selector */}
        <div className="flex items-center space-x-2">
          <p className="text-sm font-medium">Кол-во тренировок</p>
          <Select
            value={`${pageSize}`}
        ...
        <div className="flex items-center">
          <div className="flex items-center justify-center text-sm font-medium lg:mr-2">
