...
const SocialMainPage = () => {
  ...
  const handleCreatePost = async (e: React.FormEvent) => {
    ...
    setPostLoading(true);
    try {
      await createUserPostMutationFn(undefined, { text: postText, image: postImage });
      setPostText("");
      setPostImage(null);
  ...
  return (
    <>
      <SocialHeader />
      <div className="w-full flex justify-center bg-white border-b sticky top-0 z-40">
        <button
          className="flex items-center gap-2 px-4 py-2 mt-4 mb-2 rounded-full bg-black text-white font-semibold hover:bg-gray-900 transition"
