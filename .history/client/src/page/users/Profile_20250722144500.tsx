      ...
      <div className="flex min-h-svh bg-muted w-full justify-center">
        ...
        <aside className="hidden md:flex flex-col w-64 border-r bg-white p-6 gap-4 min-h-svh sticky top-0">
          <nav className="flex flex-col gap-2">
            <Link
              to="/u/"
              className={`font-semibold text-lg px-3 py-2 transition hover:bg-sidebar-accent hover:text-sidebar-accent-foreground ${window.location.pathname === "/u/" ? "bg-sidebar-accent text-sidebar-accent-foreground font-medium" : "text-sidebar-foreground"}`}
            >
              <span className="pl-2">Лента</span>
            </Link>
            <Link
              to="/u/users"
              className={`font-semibold text-lg px-3 py-2 transition hover:bg-sidebar-accent hover:text-sidebar-accent-foreground ${window.location.pathname === "/u/users" ? "bg-sidebar-accent text-sidebar-accent-foreground font-medium" : "text-sidebar-foreground"}`}
            >
              <span className="pl-2">Пользователи</span>
            </Link>
            <Link
              to="/u/articles"
              className={`font-semibold text-lg px-3 py-2 transition hover:bg-sidebar-accent hover:text-sidebar-accent-foreground ${window.location.pathname === "/u/articles" ? "bg-sidebar-accent text-sidebar-accent-foreground font-medium" : "text-sidebar-foreground"}`}
            >
